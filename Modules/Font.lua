...
function Module:OnInitialize()
    ...
    NAMEPLATE_FONT              = PhoUI.DEFAULT_FONT
    NAMEPLATE_SPELLCAST_FONT    = PhoUI.DEFAULT_FONT
    UNIT_NAME_FONT_ROMAN        = PhoUI.DEFAULT_FONT
    
    local FORCED_FONT_SIZE = {9, 9, 14, 14, 12, 64, 64}
    local FONT_OBJ = {
    ...
    for INDEX, FONT in pairs(FONT_OBJ) do
        local _, size, style = FONT:GetFont()
        FONT:SetFont(PhoUI.DEFAULT_FONT, FORCED_FONT_SIZE[INDEX] or size, style)
    end
end